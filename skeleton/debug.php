...
// plugins register themselves and define functions

// the $fbx['debug_buffer'] is used directly by the runtime, since this file is a plugin and not necessarily present.
...
function debug_output($item_name)
{
	...
	if (count($fbx['user_debug_buffer'])) 
	{
		$output = array();
		$filename_len = 0;
